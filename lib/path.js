...
/**
 * 判断url是否本地路径，也就排除外部资源的情况。
 *
 *     @example
 *     edp.path.isLocalPath( '//www.baidu.com/img/logo.gif' ) === false;
 *     edp.path.isLocalPath( 'http://www.baidu.com/img/logo.gif' ) === false;
 ...
 *
 *     @example
 *     edp.path.satisfy( 'src/a.js', 'src/*.js' ) === true;
 *
