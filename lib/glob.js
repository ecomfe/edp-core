 ...
 * @param {(function(string, *):boolean)=} opt_comparator 用来判断是否符合要求的函数，如果符合返回true.
 *
 * @return {Array.<*>}
 */
exports.filter = function( patterns, allCandidates, opt_comparator ) {
    var result = [];
    var util = require( 'util' );

    var comparator = opt_comparator || function( pattern, item ) {
