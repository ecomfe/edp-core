 ...
 * @param {string=} opt_dir 指定的目录，没有指定的话，默认扫描module.conf里面的配置的目录.
 *
 * @return {Array.<string>}
 */
exports.getAllModules = function( moduleConfigFile, opt_dir ) {
    return require( './esl/get-all-modules' )( moduleConfigFile, opt_dir );
}
