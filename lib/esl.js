...
exports.getModuleFile = function( moduleId, moduleConfigFile, moduleConfig ) {
    return require( './esl/get-module-file' )( moduleId, moduleConfigFile, moduleConfig );
};
...
exports.getAllModules = function( moduleConfigFile, dir ) {
    return require( './esl/get-all-modules' )( moduleConfigFile, dir );
};
...
exports.toUrl = function( moduleId, baseId, baseFile, moduleConfigFile ) {
    return require( './esl/to-url' )( moduleId, baseId, baseFile, moduleConfigFile );
};
